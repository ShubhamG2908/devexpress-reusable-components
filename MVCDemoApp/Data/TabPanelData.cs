...
namespace MVCDemoApp.Data
{
    internal  class TabPanelData
    {
        ...
        public static readonly List<TaskItem> NotStartedTaskItems = new List<TaskItem>() {
            new TaskItem {
                status = "Not Started",
                priority = "high",
        ...
        public static readonly List<TaskItem> HelpNeededTaskItems = new List<TaskItem>() {
            new TaskItem {
                status = "Help Needed",
                priority = "low",
                text = "TV Recall",
        ...
        public static readonly List<TaskItem> InProgressTaskItems = new List<TaskItem>() {
            new TaskItem {
                status = "In Progress",
                priority = "medium",
                text = "Online Sales",
        ...
        public static readonly List<TaskItem> DeferredTaskItems = new List<TaskItem>() {
            new TaskItem {
                status = "Deferred",
                priority = "medium",
                text = "New Database",
        ...
        public static readonly List<TaskItem> RejectedTaskItems = new List<TaskItem>() {
            new TaskItem {
                status = "Rejected",
                priority = "high",
        ...
        public static readonly List<TaskItem> CompletedTaskItems = new List<TaskItem>() {
            new TaskItem {
                status = "Completed",
                priority = "medium",
        ...
        public static readonly List<TabPanelItem> TabPanelItems = new List<TabPanelItem>() {
            new TabPanelItem {
                icon = "description",
                title = "Not Started",
